...
test('form validation reports SPEC, Run ID, profile, and numeric errors', () => {
  ...
  const valid = {
    ...
    max_check_repair_attempts: 0, max_correction_cycles: 0, decomposition: 'balanced',
  ...
  assert.match(validateRunForm({ ...valid, max_correction_cycles: -1 }, roles), /Repair budgets/);
