...
_TRANSIENT_EXTERNAL_CODES = frozenset({
    ...
    "LLM_FAILURE", "LLM_TRANSPORT_EXHAUSTED",
    "DNS_UNAVAILABLE", "NETWORK_UNAVAILABLE",
...
_EXTERNAL_STRATEGY_CODES = frozenset({
    ...
    "LLM_TIMEOUT", "LLM_TRANSPORT_FAILURE", "LLM_TRANSPORT_EXHAUSTED",
    "LLM_FAILURE", "LLM_AUTH_FAILURE",
    "MISSING_PROVIDER_CREDENTIALS", "PROVIDER_CREDENTIALS_MISSING",
