...
<label for="max-review-repair-cycles">Maximum review-repair cycles</label><select id="max-review-repair-cycles" name="max_review_repair_cycles" required>{review_cycle_options}</select>
<label for="check-repair-profile">Check-repair profile</label><select id="check-repair-profile" name="check_repair_profile">{options["repair"]}</select>
